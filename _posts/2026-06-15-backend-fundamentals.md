...
> 이 글은 *3 년차 부터 *9 년차 까지 *공통 으로 *되돌아 *오는 *질문* — *백엔드 의 *기본 기 의 *지도*.
...
1. ***"신입 의 *과목*"*** — *암기 단계 의 *짧은 *학습*. *9년차 부터 *불필요*.
2. ***"학교 *과목 의 *반복*"*** — 학부 OS / DB / 네트워크 *재 복습*.
3. ***"AI 가 *해주 니까 *알 필요 *없다*"*** — *최신 *오해*.

### *진실*

1. ***평생 *되돌아 오는 *질문 의 *답***. 9년차 의 *시니어* 도 *매주 의 *결정 마다 *기본 기 *활용*.
...
***9 년차의 *진짜 강점 = *1 언어 의 *깊이***. *5 언어 *얕게 *보다 *훨씬 *낫다*.
...
→ *틀림*. *9년차 도 *주 1~2회 *기본 기 *복기*. *시각 의 *재 형성*.
...
2. ***연차 별 *모양 의 *다르지만 *기본 기 는 *연속*** — *9 년차 의 *기본 기 = 1 년차 의 *기본 기 의 *재 정의*.
...
> 본 글은 *9년차 백엔드 *엔지니어 의 *학습 회고*. *권장 의 *순서 는 *환경 / 사람 *별 *달라질 수 있음*. *원리 + 반복 의 *필요성* 만 은 *공통*.
